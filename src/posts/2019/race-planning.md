...
![Recent Race Power and Time - SuperPower Calculator](images/spc-race-power-time-Jd6HC4hRg810.png)
...
![Lookup Riegel - SuperPower Calculator](images/spc-race-distance-riegel-wAeiWvxGRZYx.png)
...
![Elevation gain from MapMyRun](images/spc-elevation-gain-mapmyrun-7juoJa20DviS.png)
...
![Elevation gain from Ride with GPS](images/elevation-gain-ride-with-gps-v9kIFYumIMbj.png)
...
![Calculate Power metrics (RE, HPR, LSS/kg, CVI) for up to 10 completed Activities - SuperPower Calculator](images/spc-calculate-power-metrics-XbIKugOhYTj4.png)

### Step 4c

Enter your `Stryd Weight` (the value set in your Stryd profile).

![Stryd Weight - SuperPower Calculator](images/spc-stryd-weight-ViEalj43Vdia.png)
...
![Power, Time, and Distance - SuperPower Calculator](images/spc-power-time-distance-x95L42n8FO9V.png)
...
![Running Effectiveness - SuperPower Calculator](images/spc-running-effectiveness-uHvls4mw94UB.png)
...
![Running Effectiveness Adjustment Factor](images/re-adjustment-factor-v6-FtCg6G4h0ei4.png)
...
![Example - Running Effectiveness Adjustment Factor](images/running-effectiveness-adjustme-fWX8ZuGL2hx3.png)
...
![Climbing and CVI - SuperPower Calculator](images/spc-climbing-cvi-fL26JCPJsSaJ.png)
...
![Generate Race Power Scenarios using pairs of Riegel Exponents and RE - SuperPower Calculator](images/spc-generate-race-power-scenar-Z3plXb70xLRy.png)

### Step 5b

Enter your `Stryd Weight` and `FTP/CP` (calculated above) under the `Basic data` section.

![Stryd Weight and FTP/CP - SuperPower Calculator](images/spc-weight-ftp-sJEHEqPI4HTt.png)
...
![Target Distance - SuperPower Calculator](images/spc-target-distance-Pm66ehBCxUYS.png)
...
![Typical Training Altitude, Temperature, and Humidity - SuperPower Calculator](images/spc-typical-training-environme-vjHcVPvxyWJ2.png)
...
![Time Machine in Dark Sky](images/darksky-time-machine-Vci3Hkr2nmU1.png)
...
![Klimat description in Strava](images/strava-klimat-example-OVODwVUgj1F7.png)
...
![Environment Adjustments - SuperPower Calculator](images/spc-environment-adjustments-GbkNAKphFFrD.png)
...
![Environment-Adjusted CP - SuperPower Calculator](images/spc-ec-adjusted-cp-ASMj6vAN0FrR.png)
...
![Recent Race Time and Distance - SuperPower Calculator](images/spc-recent-race-time-distance-jRIRRYzzkDth.png)
...
![Riegel Exponent and Range - SuperPower Calculator](images/spc-most-likely-riegel-range-TZGailRNBnwH.png)
...
![Riegel Exponent Groups - SuperPower Calculator](images/spc-riegel-groups-CNedkoqHCNMt.png)
...
![Target RE Groups - SuperPower Calculator](images/spc-re-groups-yMXGtl0TAbAr.png)
...
![Target Power Ranges - SuperPower Calculator](images/spc-race-targets-kLfGUpRE0bco.png)
