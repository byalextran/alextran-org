...
metadata:
  uuid: 11ty/import::wordpress::http://alextran.org/?p=3040
  type: wordpress
  url: https://www.alextran.org/porn-temptation/
---
...
Dear reader, I’d like to introduce you to my very close friends: [uBlock Origin](https://github.com/gorhill/uBlock) and [OpenDNS](https://www.opendns.com/).
...
As an added bonus, it makes browsing the web _infinitely_ cleaner and more pleasant. It’ll even protect you from spammy pop-ups, malicious ads, and anything else shady the Internet might throw at you.

_Everyone_ should install it. It’s that good.

Check it out.

![uBlock Origin - Before and After](ublock-enabled-FSY9VrltZUhb.gif)
...
Where uBlock Origin prevents me from being tempted by ads, OpenDNS kicks in when temptation overtakes me. I’ll get this when I try to visit a pornography or other adult themed website.

![Blocked by OpenDNS](opendns-blocked-300x227-ldxaJqzZJF3t.gif)

\[clickToTweet tweet=”These two things help me eliminate porn temptation today so I won’t have to resist it tomorrow.” quote=”These two things help me eliminate porn temptation today so I won’t have to resist it tomorrow.”\]
...
-   [Safari](https://github.com/el1t/uBlock-Safari#installation) (still in development, not recommended)

### Setting Up OpenDNS

There are two main content filtering services from OpenDNS.

1.  [OpenDNS Family Shield](https://www.opendns.com/home-internet-security/parental-controls/opendns-familyshield/)
    -   Pre-configured to block all adult content
2.  [OpenDNS Home](https://www.opendns.com/home-internet-security/parental-controls/opendns-home/)
...
Depending on your router, sometimes the login information (web address, username, password) is displayed on your router. Or if you’re lucky, you can [visit this page](https://support.opendns.com/forums/21618374) and see if there are specific instructions for your router.

#### Step 3

Once you’ve logged in, find where you can specify your own DNS servers. Again, if your router is listed, [this page will be helpful](https://support.opendns.com/forums/21618374).
...
[Test your settings](https://store.opendns.com/settings).
...
It will filter content for any device connected to your router. On the flip side, any computer or smartphone not connected to your router will _not_ be protected.
...
_What are some other ways we can eliminate temptation today?_

Photo courtesy of [Beshef](https://flic.kr/p/75oehG).