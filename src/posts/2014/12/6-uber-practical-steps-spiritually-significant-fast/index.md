...
Do this _before_ you start your fast. Alternatively, make a list of fast-approved recipes and only eat those recipes during the fast.
...
Again, it’s all about making decisions at the start which drastically reduce the number of stressful game-time decisions. Game-time decisions are often when you’re the most tired, have the least amount of energy, and zero willpower to stick to your fast. (It’s called [decision fatigue](http://jamesclear.com/willpower-decision-fatigue).)
...
>
> <cite><a href="http://www.cru.org/train-and-grow/devotional-life/personal-guide-to-fasting.2.html">Why You Should Fast</a></cite>
